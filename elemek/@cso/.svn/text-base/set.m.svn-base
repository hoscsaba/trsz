   ...
   case 'hely'
	...
	DD(i,i-2)=1; DD(i,i-1)=-8; DD(i,i+2)=-1; DD(i,i+1)=8;
     ...
     case 'femi'
      ...
      cso.DD=[zeros(N+1,N+1) DD1; DD2 zeros(N+1,N+1)];
      
     otherwise
      fprintf('\n\n ERROR!! -> Unknown spatial disretization in %s',cso.name);
